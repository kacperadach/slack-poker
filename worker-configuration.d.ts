/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c792c7abb555939de4ffebc1473b9bee)
// Runtime types generated with workerd@1.20260114.0 2025-04-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PokerDurableObject";
	}
	interface Env {
		SLACK_SIGNING_SECRET: string;
		SLACK_BOT_TOKEN: string;
		POKER_DURABLE_OBJECT: DurableObjectNamespace<import("./src/index").PokerDurableObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SLACK_SIGNING_SECRET" | "SLACK_BOT_TOKEN">> {}
}
