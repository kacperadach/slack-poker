...
describe("Poker Durable Object", () => {
  ...
  it("game scenario 12 - pre-nh", async () => {
    ...
    // Check that :nh: message appeared (uses bold display name, not tag)
  ...
  it("game scenario 19 - pre-ah", async () => {
    ...
    // Check that :ah: message appeared (uses bold display name, not tag)
    const endMessages = sayFn.mock.calls[0][0].text;
  ...
  it("game scenario 24 - pre-call invalidated by raise", async () => {
    ...
    await call(env, contextAlice, createGenericMessageEvent("alice"));
    // Non-turn messages use bold display names, not tags
  ...
  it("builds showdown win percentage message from street calculations", async () => {
    ...
    // Showdown messages use bold display names, not tags
